...
public class ShiftMonthView extends MonthView {
...
//    private Paint mSolarTermTextPaint = new Paint();
    ...
    public ShiftMonthView(Context context) {
        super(context);
...
//        mSolarTermTextPaint.setTextAlign(Paint.Align.CENTER);
        ...
        mCurrentDayPaint.setColor(Color.parseColor("#5546C9C3"));
 ...
 */
        ...
        mSelectedPaint.setColor(Color.parseColor("#5546C9C3"));
...
//        mSolarTermTextPaint.setTextSize(mCurMonthLunarTextPaint.getTextSize());
        mSelectedPaint.setColor(Color.parseColor("#46C9C3"));
        mRadius = Math.min(mItemWidth, mItemHeight) / 14 * 5;
    }
...
//        if (calendar.isWeekend() && calendar.isCurrentMonth()) {//周末颜色更改
...
//            mCurDayLunarTextPaint.setColor(Color.parseColor("#ffffff"));//农历画笔
            canvas.drawText(String.valueOf(calendar.getDay()), cx, mTextBaseLine + top,
