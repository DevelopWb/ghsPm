...
public class BuglyConfig {
    public static final String BUGLY_APP_ID = "57c2dcd4cd"; //  替换成bugly上注册的appid
    ...
    public static void init(Context context) {
         ...
         */
        Beta.largeIconId = R.mipmap.ghpm_icon;
       // 设置是否显示消息通知
         ...
         */
        Beta.smallIconId = R.mipmap.ghpm_small_icon;
...
//        Beta.tipsDialogLayoutId = R.layout.tips_dialog;
     ...
     /*  Beta.upgradeDialogLifecycleListener = new UILifecycleListener<UpgradeInfo>() {
       ...
       /* Beta.upgradeListener = new UpgradeListener() {
        ...
        //        Bugly.init(getApplicationContext(), BUGLY_APP_ID, true, strategy);
