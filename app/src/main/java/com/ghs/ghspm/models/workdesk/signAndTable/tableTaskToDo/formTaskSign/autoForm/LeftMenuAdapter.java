 ...
 */
public class LeftMenuAdapter extends BaseQuickAdapter<AutoFormBean.DataBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, AutoFormBean.DataBean item) {
        ...
        item.setPresentPosition(positon);
        boolean  selected = item.isSelected();
        if (selected) {
            helper.setBackgroundRes(R.id.tv_table_content_item_ll,R.drawable.patrol_form_record_selected_left_sp);
        }else{
            helper.setBackgroundRes(R.id.tv_table_content_item_ll,R.drawable.bg_patrol_form_left_content);
