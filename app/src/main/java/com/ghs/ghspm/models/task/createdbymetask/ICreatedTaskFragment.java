package com.ghs.ghspm.models.task.createdbymetask;
...
public class ICreatedTaskFragment extends BaseFragment<TaskContract.ITaskView, TaskPresent> implements TaskContract.ITaskView, RequestStatus, View.OnClickListener {
    ...
    public static ICreatedTaskFragment getInstance() {
    ...
    protected void lazyLoad() {
        offset = 0;
        getPresenter().getTasks(Contract.I_PUBLISHED_TASK, UserInfoUtil.getInstance().getUserId(), offset, limit, TaskContract.REFRESH);
    ...
    private void initView(View view) {
        ...
        adapter.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
            ...
            public void onLoadMoreRequested() {
                getPresenter().getTasks(Contract.I_PUBLISHED_TASK, UserInfoUtil.getInstance().getUserId(), offset, limit, "");
    ...
    private static class FirstFragmentHolder {
        private static ICreatedTaskFragment instatce = new ICreatedTaskFragment();
    }
