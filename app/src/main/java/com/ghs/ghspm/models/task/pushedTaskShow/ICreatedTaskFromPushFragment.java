...
public class ICreatedTaskFromPushFragment extends BaseFragment<TaskContract.ITaskView, TaskPresent> implements TaskContract.ITaskView, RequestStatus, View.OnClickListener {
    ...
    public static ICreatedTaskFromPushFragment getInstance() {
    ...
    private static class FirstFragmentHolder {
        private static ICreatedTaskFromPushFragment instatce = new ICreatedTaskFromPushFragment();
    }
