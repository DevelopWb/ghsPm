...
public class RelatedToMeTaskFromPushFragment extends BaseFragment<TaskContract.ITaskView, TaskPresent> implements TaskContract.ITaskView, RequestStatus, View.OnClickListener {
    ...
    public static RelatedToMeTaskFromPushFragment getInstance() {
    ...
    private static class FirstFragmentHolder {
        private static RelatedToMeTaskFromPushFragment instatce = new RelatedToMeTaskFromPushFragment();
    }
