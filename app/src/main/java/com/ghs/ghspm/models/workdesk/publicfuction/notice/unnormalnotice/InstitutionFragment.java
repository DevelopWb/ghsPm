...
public class InstitutionFragment extends BaseFragment<NoticeContract.INoticeView, NoticePresent> implements NoticeContract.INoticeView {
    ...
    private void initView(View view) {
        ...
        noticeAdapter.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
            ...
            public void onLoadMoreRequested() {
                getPresenter().getNoticeList(offset,limit,2, UserInfoUtil.getInstance().getVillageId(), UserInfoUtil.getInstance().getUserId(), "");
        ...
        mSwipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                getPresenter().getNoticeList(offset,limit,2, UserInfoUtil.getInstance().getVillageId(), UserInfoUtil.getInstance().getUserId(), RequestStatus.REFRESH);


            }
        });
        noticeAdapter.setEmptyView(getAdapterEmptyView("很干净，一条制度也没有"));
