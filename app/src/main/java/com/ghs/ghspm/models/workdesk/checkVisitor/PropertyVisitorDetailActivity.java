...
/**
 * created by tobato
 * created date 2019/8/30 18:23.
 * application  物业访客详情
 */
public class PropertyVisitorDetailActivity extends BaseActivity<PropertyVisitorContract.PropertyRecordView, PropertyVisitorPresent> implements PropertyVisitorContract.PropertyRecordView {
    ...
    public void initLayoutView() {
        initActionBar("详情", "",R.drawable.bg_gray_only_bottom_deeper_gray_shape_1px);
    ...
    public void updateView(Object o, String tag) {
        ...
        switch (tag) {
            ...
            case PropertyVisitorContract.PROPERTY_RECORD_CHECKAGREE:
                showToast("已通过");
                initVisitorMsg((PropertyVisitorListBean.DataBean) o);
