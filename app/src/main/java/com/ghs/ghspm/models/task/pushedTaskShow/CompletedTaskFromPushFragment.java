...
public class CompletedTaskFromPushFragment extends BaseFragment<TaskContract.ITaskView, TaskPresent> implements TaskContract.ITaskView, RequestStatus, View.OnClickListener {
    ...
    public static CompletedTaskFromPushFragment getInstance() {
    ...
    private static class FirstFragmentHolder {
        private static CompletedTaskFromPushFragment instatce = new CompletedTaskFromPushFragment();
    }
